...
# dwave-greedy v0.2 - pip install dwave-greedy
...
def main(args):
    ...
    # Set up the greedy solver.
    solver = greedy.SteepestDescentSolver()

    # Sample the greedy solver `args.runtime_limit` number of times.
    start_time = time.time()
    sample_set = solver.sample_ising(h, J, num_reads = args.runtime_limit)
...
def build_cli_parser():
    ...
    parser.add_argument('-rtl', '--runtime-limit', help = 'greedy solver runtime limit (number of reads)', type = int, default = 1)
