...
# dwave-neal v0.5 - pip install dwave-neal
...
def main(args):
    ...
    # Set up the simulated annealing sampler.
...
def build_cli_parser():
    ...
    parser.add_argument('-rtl', '--runtime-limit', help = 'simulated annealing solver runtime limit (number of reads)', type = int, default = 1)
